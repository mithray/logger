...
const logRequire = require('./logRequire.js')
const prettyMs = logRequire('pretty-ms')
...
function setProcess(std, options) {
    let elapsedTimeHuman = prettyMilliseconds(process.uptime() * 1000)
